...
export const NAV_DATA: NavData[] = [
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://static.eleduck.com/_next/static/media/icon-500.d77f6cfc.png',
        title: '电鸭社区',
        link: 'https://eleduck.com/'
      },
      {
        icon: 'https://maliquankai.oss-cn-shenzhen.aliyuncs.com/favicon.ico',
        title: '码力全开',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://zh.z-library.se/apple-touch-icon.png?v=1',
        title: 'z-library',
        desc: '号称世界最大的免费电子图书馆',
